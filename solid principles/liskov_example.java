...
public class ChartScriptController {
    ...
    private String getChartJS(@RequestParam String dashboardId, @RequestParam String chartId) {
		...
		// ABOVE IS SPRINT BOOT CONVENTION | ChartScriptGeneratorFactoryImpl.java WHICH IMPLEMENTS ChartScriptGeneratorFactory
...
https://github.com/rfnel/chartool/blob/udemy-reference/src/main/java/za/co/rin/chartool/charts/controllers/ChartScriptController.java